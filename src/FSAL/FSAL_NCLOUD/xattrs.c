...
fsal_status_t ncloud_list_ext_attrs(struct fsal_obj_handle *obj_hdl,
				    ...
				    int *end_of_list)
{
	LogDebug(COMPONENT_FSAL, "trace: call ncloud_list_ext_attrs");
...
{
	LogDebug(COMPONENT_FSAL, "trace: call ncloud_getextattr_id_by_name");
	struct ncloud_fsal_obj_handle *handle =
		container_of(obj_hdl, struct ncloud_fsal_obj_handle,
			     obj_handle);
...
{
	LogDebug(COMPONENT_FSAL, "trace: call ncloud_getextattr_value_by_id");
	struct ncloud_fsal_obj_handle *handle =
		container_of(obj_hdl, struct ncloud_fsal_obj_handle,
			     obj_handle);
...
fsal_status_t ncloud_getextattr_value_by_name(struct fsal_obj_handle *obj_hdl,
					      ...
					      size_t *p_output_size)
{
	LogDebug(COMPONENT_FSAL, "trace: call ncloud_getextattr_value_by_name");
	struct ncloud_fsal_obj_handle *handle =
		container_of(obj_hdl, struct ncloud_fsal_obj_handle,
			     obj_handle);
...
fsal_status_t ncloud_setextattr_value(struct fsal_obj_handle *obj_hdl,
				      ...
				      int create)
{
	LogDebug(COMPONENT_FSAL, "trace: call ncloud_getextattr_value");
	struct ncloud_fsal_obj_handle *handle =
		container_of(obj_hdl, struct ncloud_fsal_obj_handle,
			     obj_handle);
...
fsal_status_t ncloud_setextattr_value_by_id(struct fsal_obj_handle *obj_hdl,
					    ...
					    size_t buffer_size)
{
	LogDebug(COMPONENT_FSAL, "trace: call ncloud_setextattr_value_by_id");
	struct ncloud_fsal_obj_handle *handle =
		container_of(obj_hdl, struct ncloud_fsal_obj_handle,
			     obj_handle);
...
fsal_status_t ncloud_remove_extattr_by_id(struct fsal_obj_handle *obj_hdl,
					  unsigned int xattr_id)
{
	LogDebug(COMPONENT_FSAL, "trace: call ncloud_remove_extattr_by_id");
	struct ncloud_fsal_obj_handle *handle =
		container_of(obj_hdl, struct ncloud_fsal_obj_handle,
			     obj_handle);
...
fsal_status_t ncloud_remove_extattr_by_name(struct fsal_obj_handle *obj_hdl,
					    const char *xattr_name)
{
	LogDebug(COMPONENT_FSAL, "trace: call ncloud_remove_extattr_by_name");
	struct ncloud_fsal_obj_handle *handle =
		container_of(obj_hdl, struct ncloud_fsal_obj_handle,
			     obj_handle);
